package com.digitaldot.user.mapper;

import com.digitaldot.user.controller.v1.UserController;
...
public class UserMapper {
    ...
    public UserDto toLinkDto(UserDto userDto) throws ValidatorErrorException, ApiException {
        return toLinkDto(userDto, hideLinksUtils);
    }

    public UserDto toLinkDto(UserDto userDto, HideLinksUtils hideLinksUtils) throws ValidatorErrorException, ApiException {
